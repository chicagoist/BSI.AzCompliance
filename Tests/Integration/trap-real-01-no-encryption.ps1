...
az vm create --name "VM-web" --resource-group $rgName  --assign-identity "[system]" --image Ubuntu2204
az vm create --name "VM-app" --resource-group $rgName  --assign-identity "[system]" --public-ip-address "" --image Ubuntu2204
az vm create --name "VM-db" --resource-group $rgName  --assign-identity "[system]" --public-ip-address "" --image Ubuntu2204
