...
az vm create --name "VM-web" --resource-group $rgName --encryption-at-host --image Ubuntu2204
az vm create --name "VM-app" --resource-group $rgName --encryption-at-host --public-ip-address "" --image Ubuntu2204
az vm create --name "VM-db" --resource-group $rgName --encryption-at-host --public-ip-address "" --image Ubuntu2204
